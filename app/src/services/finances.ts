...
export async function getUserBills(userGuid: string): Promise<Bill[]> {
    //todo fetch function
    // const { data } = await axios.get("api/finances?userGuid=`${userGuid}`");
    // return data;
...
export async function getGroupBills(groupGuid: string): Promise<Bill[]> {
    //todo fetch function
    // const { data } = await acios.get("api/finances?userGuid=`${userGuid}`");
    // return data;
